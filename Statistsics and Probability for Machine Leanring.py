...
# Load the dataset
dataset = pd.read_csv("C:\\Users\\Owner\\Documents\\GitHub\\Python_AI_Course\\dataset_1.csv")
...
if len(dataset) >= 8:
    prob = norm.cdf(2.5, loc=dataset['columns_1'].mean(), scale=dataset['column_1'].std())
...
if len(group_a_data) >= 8 and len(group_b_data) >= 8:
    ...
    print("Inssufiecnt data for hypothesis testing.")
